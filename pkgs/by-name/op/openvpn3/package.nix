...
stdenv.mkDerivation rec {
  ...
  patches = [
    ./0001-customizable-asio-path.patch
    ./0002-customizable-installation-paths.patch
  ];
  ...
  mesonFlags = [
    # TODO: remove this suppression once the issue is fixed in upstream
    (lib.mesonOption "cpp_args" "-Wno-error=non-virtual-dtor")
