...
in rec {
  ...
  netboot.x86_64-linux = (import lib/eval-config.nix {
      system = "x86_64-linux";
      modules = [
  ...
  netboot_bundle.x86_64-linux = pkgs.symlinkJoin {
    name = "netboot";
    paths = [
      netboot.x86_64-linux.netbootRamdisk
      netboot.x86_64-linux.kernel
      netboot.x86_64-linux.netbootIpxeScript
    ];
  };
